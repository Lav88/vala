                    ...
                    <div class="col-md-6 col-lg-6 col-xl-7">
                        <div class="content">
                            ...
                            <div class="tittle-wrp">
                                <h2>Voice of <br> <span>Africa</span><br> Landshut e.V</h2>
                            </div>
                            <div class="btn-wrp">
                        ...
                        <div class="layer-style">
                            <div class="thumb scene">
                                <span class="scene-layer" data-depth="0.20">                     
                                    <img class="" src="/images/slider/2.png" alt="Image">
                                </span>
                            ...
                            <div class="donate-circle-wrp">
                                <div class="donate-content">
                                    <div class="raised-amount">10Years</div>
                                    <img class="line-shape-img" src="/images/shape/line-s2.png" alt="Image">
                                    <h5 class="donate-title">Gemeinsam gegen Rassismus</h5>
                                </div>
                            </div>
                        </div>
                    </div>
