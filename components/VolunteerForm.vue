                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row row-gutter-20">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <select class="form-control"  id="join" name="join">
                                                    <option value="" disabled selected>Area of Intereset</option>
                                                    <option value="Become a member">Become a member</option>
                                                    <option value="Afrika Tag">Afrika Tag</option>
                                                    <option value="FC VALA">FC VALA</option>
                                                    <option value="VALA Cafe">VALA Cafe</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
