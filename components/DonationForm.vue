<template>
    <div class="donation-form bgcolor-theme3">
        <div class="section-title">
            ...
            <p class="text-white">Your help goes a long way. Supporting us means supporting others who rely on vital services needed to help them integrate in a place thats very different a new.
                <br>It also means that you support the various works and events we do to help make our local community a more open and tolerant place.
            </p>
            <h4 class="text-theme-color">Thank You</h4>
            <img class="line-shape" src="/images/shape/line-t3.png" alt="image">
        </div>
        <form>
            <div class="amount-info">
                <div class="donate-amount">$2</div>
